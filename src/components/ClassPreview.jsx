...
const ClassPreview = ({claseInfo, handleDeleteClass, editionMode}) => {
  ...
  return (
    <div
    className='my-2 p-4 px-4 text-xl  font-bold  w-full bg-slate-100 flex flex-col md:flex-row md:justify-between rounded-xl border-2 border-gray-400 shadow-xl'
...
>
    ...
    <div className='flex items-center justify-center'>
       ...
       <p className='block text-center mx-2'>{claseInfo.name}</p> 
    </div>
